 ...
 INSERT INTO tournaments (id, name, type, matches_remaining, winner, home_aways_each, start_date, end_date, created_player) VALUES (1, 'The Best CUP EVER', 'ROUND_ROBIN', 12, 0, 1, '2018-02-10', '2018-05-31', 1);
 INSERT INTO tournaments (id, name, type, matches_remaining, winner, home_aways_each, start_date, end_date, created_player) VALUES (2, 'The Second Best CUP EVER', 'ROUND_ROBIN', 12, 0, 1, '2018-03-10', '2018-09-30', 1);
